  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand className="header-logo" full={{ src: logo, alt: 'Construction Logo' }}/>
        ...
        <Nav className="ml-auto" navbar>
          ...
          <UncontrolledDropdown nav direction="down">
            ...
            <DropdownMenu right>
              ...
              <DropdownItem><Link to="/admin/change-password" className="nav-link"><i className="fa fa-lock"></i> Change Password</Link></DropdownItem>
